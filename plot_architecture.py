...
def draw_architecture(output_path):
    ...
    def draw_arrow(start_pos, end_pos):
        ax.annotate(
            ...
            xytext=start_pos,
            arrowprops=dict(
                arrowstyle='->', lw=1.5, color='black', shrinkA=0, shrinkB=0
            ),
        )
    ...
    draw_arrow((50, 90), (30, 80))  # To Semantic
    ...
    draw_box(
        55, 44, 'Global Avg Pooling', width=30, height=6, color=branch_forensic_color
    )
    ...
    plt.title(
        'Arhitectura DeForge-AI: Fluxul de Procesare',
        fontsize=16,
        fontweight='bold',
        pad=20,
    )
